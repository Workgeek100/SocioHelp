    ...
    render(){
        return(
            <View style = {styles.container}>
                ...
                <Text style = {{marginTop: RFValue(10)}}>Forgot your password?</Text>
                 <TouchableOpacity
                onPress = {()=>{
                    this.props.navigation.navigate("UserForgotPassword")
                }}
                >
                    <Text style = {styles.underline}>Reset Password</Text>
                </TouchableOpacity>
                ...
                <Text style= {{color: 'grey', marginTop: RFValue(10),}}>───────────────────────────</Text>

                {/* Button to go to signup screen */}
                <Text style = {{marginTop: RFValue(10)}}>Dont have an account?</Text>
                 <TouchableOpacity
                onPress = {()=>{
